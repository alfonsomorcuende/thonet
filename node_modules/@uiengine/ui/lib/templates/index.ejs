...
<html lang="<%= lang %>" class="uie">
  <head>
    ...
    <link href="<%= basePath %>/_assets/styles/uiengine.a5496243e7b949fbd7fe.css" rel="stylesheet">
    <link rel="stylesheet" href="<%= basePath %>/_assets/styles/hljs/<%= hljs %>.css" id="hljs" data-default="<%= hljs %>" data-tmpl="<%= basePath %>/_assets/styles/hljs/%s.css">
    <%_ if (customStylesFile) { _%>
    <link rel="stylesheet" href="<%= customStylesFile %>">
    <%_ } _%>
    <script type="text/javascript">
      window.UIengine = {};
      window.UIengine.base = <%- helpers.htmlescape(base) %>;
      window.UIengine.state = <%- helpers.htmlescape(state) %>;
      window.UIengine.previewSrc = "<%= basePath %>/_assets/scripts/uiengine-preview.7d527f1efb61f66ec24a.js";
      window.UIengine.manifestSrc = "<%= basePath %>/_assets/scripts/manifest.1c9d7a27c3271c592a6e.js";
      window.UIengine.locales = {"de":{"navigation":{"toggle":"Navigation umschalten"},"options":{"info":"Info","properties":"Properties","preview":"Vorschau","code":"Code","copy_permalink":"Variantenlink kopieren","open_in_window":"In separatem Fenster öffnen","edit_on_codepen":"In Codepen öffnen","reset":"zurücksetzen","toggle":"umschalten"},"code":{"raw":"Code","context":"Daten","rendered":"HTML"},"token":{"name":"Name","type":"Typ","icon":"Icon","demo":"Demo","value":"Wert","usage":"Gebrauch","license":"Lizenz","fontface":"Schriftart","fontweight":"Schriftschnitt","variable":"Variable","description":"Beschreibung","reference":"Referenz"},"entities":{"property_name":"Property","property_type":"Typ","property_description":"Beschreibung","property_required":"Pflicht","property_default":"Standard"},"footer":{"version":"Version","last_update":"Letztes Update am"},"search":{"toggle":"Suche umschalten","title":"Suchergebnisse für \"%{query}\"","no_results":"Leider konnten keine passenden Suchergebnisse gefunden werden."},"settings":{"title":"Einstellungen","locale":"Sprache","hljs":"Highlight-Theme","preview_mode":"Vorschaumodus"},"not_found":{"title":"Nicht gefunden","content":"Diese Seite existiert leider nicht."}},"en":{"navigation":{"toggle":"Toggle navigation"},"options":{"info":"Info","properties":"Properties","preview":"Preview","code":"Code","copy_permalink":"Copy link to variant","open_in_window":"Open in separate window","edit_on_codepen":"Edit on Codepen","reset":"reset","toggle":"toggle"},"code":{"raw":"Code","context":"Data","rendered":"HTML"},"token":{"name":"Name","type":"Type","icon":"Icon","demo":"Demo","value":"Value","usage":"Usage","license":"License","fontface":"Typeface","fontweight":"Weight","variable":"Variable","description":"Description","reference":"Reference"},"entities":{"property_name":"Property","property_type":"Type","property_description":"Description","property_required":"Required","property_default":"Default"},"footer":{"version":"Version","last_update":"Last updated on"},"search":{"toggle":"Toggle search","title":"Search results for \"%{query}\"","no_results":"Unfortunately there is no content matching your search query."},"settings":{"title":"Settings","locale":"Locale","hljs":"Highlight-Theme","preview_mode":"Preview Mode"},"not_found":{"title":"Not Found","content":"This page does not exist."}}};
    </script>
  </head>
  <body>
    ...
    <div id="app"></div>
    <script type="text/javascript" src="<%= basePath %>/_assets/scripts/manifest.1c9d7a27c3271c592a6e.js"></script>
    <script type="text/javascript" src="<%= basePath %>/_assets/scripts/uiengine.42f63dcd0692847e0be2.js"></script>
  </body>
</html>
